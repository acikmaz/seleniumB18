...
public class NegativeLoginTests {
    ...
    public void negative_login_test(){
        ...
        passwordInput.sendKeys("ffbkdhfsdfh");
        //String password = ConfigurationReader.getProperty("storemanager_passwprd");
    ...
    public void negative_login_test_with_page_object(){
        ...
        loginPage.passwordInput.sendKeys("fafjdfkds");

        //click using login page object
        loginPage.loginButton.click();

        //asserting error message is displayed
        Assert.assertTrue(loginPage.errorMessage.isDisplayed(), "assert message is NOT displayed");
